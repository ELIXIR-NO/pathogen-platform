	...
	return (
		<section className="flex flex-col space-y-6">
			...
			<p className="text-justify">
				...
				individuals, animals, or contaminated surfaces and is estimated to have
				a 10% fatality rate. The virus is considered endemic to Africa and
				occurs naturally in countries like the Democratic Republic of Congo
				(DRC) (<ReferenceOneHoverCard />
				).
			</p>
			<HoverCard>
			...
			<HoverCard>
				...
				<HoverCardContent>
					Confirmed cases by the WHO between 2022-05-01 and 2024-02-04. Source:
					<a
			...
			<p className="text-justify">
				To provide high-value data the Tromsø node of ELIXIR Norway has created
				a{" "}
				<a
			...
			<ol className="list-decimal text-justify text-small">
				<li>
					Kugelman JR, Johnston SC, Mulembakani PM, Kisalu N, Lee MS, Koroleva
					G, McCarthy SE, Gestole MC, Wolfe ND, Fair JN, Schneider BS, Wright
					LL, Huggins J, Whitehouse CA, Wemakoy EO, Muyembe-Tamfum JJ, Hensley
					LE, Palacios GF, Rimoin AW. Genomic variability of monkeypox virus
					among humans, Democratic Republic of the Congo. Emerg Infect Dis. 2014
					Feb;20(2):232-9. doi: 10.3201/eid2002.130118. PMID: 24457084; PMCID:
					<a
				...
				<li>
					Masood W, Khan HA, Cheema HA, Shahid A, Bilal W, Kamal MA, Essar MY,
					Ahmad S, Marzo RR. The Past, Present, and Future of Monkeypox: A Rapid
					Review Regarding Prevalence and Prevention. Inquiry. 2022
					Jan-Dec;59:469580221139366. doi: 10.1177/00469580221139366. PMID:
					36484333; PMCID:{" "}
					<a
				...
				<li>
					Karagoz A, Tombuloglu H, Alsaeed M, Tombuloglu G, AlRubaish AA,
					Mahmoud A, Smajlović S, Ćordić S, Rabaan AA, Alsuhaimi E. Monkeypox
					(mpox) virus: Classification, origin, transmission, genome
					organization, antiviral drugs, and molecular diagnosis. J Infect
					Public Health. 2023 Apr;16(4):531-541. doi:
					10.1016/j.jiph.2023.02.003. Epub 2023 Feb 9. PMID: 36801633; PMCID:
					<a href="https://www.ncbi.nlm.nih.gov/pmc/articles/PMC9908738/">
						PMC9908738
					</a>
				</li>
			</ol>
