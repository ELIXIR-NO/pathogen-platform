...
const repositories: CardGridData[] = [
	{
		...
		description: "The first tigecycline resistant Enterococcus faecium in Norway was related to tigecycline exposure",
	...
	},
	{
		...
		description: "WHO considers Enterococcus as high in terms of requirement for new antibiotics.",
		...
		<>
			...
			<section className="flex flex-col space-y-6 text-justify">
				...
				<p>
					...
					could spread to the other parts of the body, causing infections. 
					...
					<span className="italic">E.faecalis</span>{" "} is easily  transferred 
					via physical contact from person to person and also via contact with 
					contaminated surfaces. Proper hand-washing techniques and a fibre-rich 
					diet play an essential role in not becoming disease-causing members 
					of the community. <span className="italic">E.faecalis</span>{" "} is 
