...
export default function FoodWaterbornePage() {
	return (
		<div className="relative min-h-screen">
			...
			<section className="flex flex-col space-y-6 text-justify">
				...
				<Image
					src="https://prod-files-secure.s3.us-west-2.amazonaws.com/f66e1653-d12d-4ace-a61b-25015798895c/6c957b65-ee3f-4b3d-8d85-91b819fbdf02/rachael-gorjestani-XlA2994Txhw-unsplash.jpg"
				...
				<p>
					The <strong>foodborne pathogens</strong> can occur at any point in the food production process, from farm to table, including during harvesting, processing, storage, or preparation. Improper handling, cooking, or storage can allow these pathogens to thrive.
				</p>
				<p>
					The <strong>waterborne pathogens</strong> typically enter water supplies through fecal contamination, inadequate wastewater treatment, or runoff from agricultural or industrial sites.
				</p>
				<p>
					The most relevant infections transmitted through food and water in Norway today are caused by norovirus, Campylobacter, Salmonella, enteropathogenic E. coli, Yersinia, and Listeria, in addition to the traditional food poisoning bacteria Clostridium perfringens, Bacillus cereus, and Staphylococcus aureus (source:{" "}
					<a
						className="text-primary hover:underline"
				...
				<p>
					...
					on the surveillance of diseases caused by food- and waterborne pathogens in Norway. In addition to food- and waterborne pathogens, the report (Overvåkning av infeksjonssykdommer som smitter fra mat, vann og dyr, inkludert vektorbårne sykdommer) includes infectious diseases caused by vector-borne and zoonotic pathogens.
				</p>
				<p>
				...
				<p>
					...
					on the surveillance of diseases caused by food- and waterborne pathogens in Norway.
				</p>
				<Image
					src="https://prod-files-secure.s3.us-west-2.amazonaws.com/f66e1653-d12d-4ace-a61b-25015798895c/98f4af50-e6fc-4863-81f5-85e04da468d1/fhi-logo-norsk-hele-navnet.webp"
					alt="FHI logo"
					width={300}
					height={100}
					className="mx-auto"
				...
				<p>
					...
					>
						Overvåkning av infeksjonssykdommer som smitter fra mat, vann og dyr, inkludert vektorbårne sykdommer
					</a>
				</p>
				...
				<Image
					src="https://prod-files-secure.s3.us-west-2.amazonaws.com/f66e1653-d12d-4ace-a61b-25015798895c/cbd85d21-c079-4ab6-bab2-ab9e721140b6/fhi-logo-norsk-hele-navnet.webp"
					alt="FHI logo"
					width={300}
					height={100}
					className="mx-auto"
				...
				<Image
					src="https://prod-files-secure.s3.us-west-2.amazonaws.com/f66e1653-d12d-4ace-a61b-25015798895c/c4125ab0-dc54-4467-8f80-c19f05fa6c4c/mattilsynet_logo_ok.png"
				...
				<Image
					src="https://prod-files-secure.s3.us-west-2.amazonaws.com/f66e1653-d12d-4ace-a61b-25015798895c/0f141a72-3ce4-42ed-a4b0-f626abdb5122/norm-logo_OK_ratio.png"
					alt="NORM-VET logo"
					width={300}
					height={100}
					className
