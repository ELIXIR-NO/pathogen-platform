	...
	return (
		<section className="flex w-full flex-col space-y-6 text-justify">
			<h1 className="text-3xl font-bold">
				Antimicrobial resistance occurrence (NORM) Antimicrobial resistance
				occurrence (NORM)
			</h1>
			<p>
			...
			<ul className="flex list-decimal flex-col space-y-1 pl-5">
				...
				<li>
					<strong>Select Regions</strong> - allows multiple regions to be
					displayed as individual lines
				</li>
				<li>
					<strong>Select Antibiotics</strong> - allows multiple antibiotics to
					be displayed as synchronised plots
				</li>
			</ul>
			<DataLoader />
			<p className="italic">
